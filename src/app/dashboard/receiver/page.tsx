  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div>
              ...
              <p className="text-gray-600">Real-time data from Firestore • Track deliveries, returns, and inventory</p>
              </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{analyticsData.deliveries.total}</p>
                <p className="text-xs text-gray-500">
                  {analyticsData.deliveries.onTime} on time • {analyticsData.deliveries.late} late
                </p>
            </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{analyticsData.returnNotes.total}</p>
                <p className="text-xs text-gray-500">
                  {formatCurrency(analyticsData.returnNotes.totalValue)} value
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">Damages</p>
                <p className="text-2xl font-semibold text-gray-900">{analyticsData.damages.total}</p>
                <p className="text-xs text-gray-500">
                  {formatCurrency(analyticsData.damages.totalCost)} cost
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{restockItems.length}</p>
                <p className="text-xs text-gray-500">
                  {restockItems.filter(r => r.priority === 'high').length} high priority
                </p>
                  </div>
              </div>
            </div>
